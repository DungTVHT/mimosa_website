			  ...
			  <table class="table"> 
		       ...
		       <td width="75%">
		          <select class="checkout_field_type_new" name="" >
					...
					<option value="datetimepicker" ><?php _e('Date Time Picker','pcfme'); ?></option>
					<option value="timepicker" ><?php _e('Time Picker','pcfme'); ?></option>
					<option value="daterangepicker" ><?php _e('Date Range Picker','pcfme'); ?></option>
					<option value="datetimerangepicker" ><?php _e('Date Time Range Picker','pcfme'); ?></option>
			       </select>
		       </td>
	           </tr>
			   <tr>
