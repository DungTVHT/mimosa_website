...
foreach ( $default_labels as $key => $label ) {
    $label_options[ $key ] = array(
        ...
        'type'        => 'text',
        'desc_tip'        => sprintf( __( 'Choose the text of "%s" label for booking products. Leave empty to get the default label.', 'yith-booking-for-woocommerce' ), yith_wcbk_get_default_label( $key ) ),
        'default'     => '',
