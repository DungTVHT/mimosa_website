    ...
    class YITH_WCBK_Google_Calendar {
        ...
        */
        ...
        public function get_booking_events_to_synchronize() {
            $events = $this->get_option( 'booking-events-to-synchronize', array( 'creation', 'update', 'status-update' ) );
            if ( !$events ) {
                $events = array();
            }
        ...
        */
        ...
        public function is_synchronize_on_status_update_enabled() {
            return in_array( 'status_update', $this->get_booking_events_to_synchronize() );
        }
