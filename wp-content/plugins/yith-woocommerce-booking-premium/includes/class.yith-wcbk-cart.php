            ...
            if ( YITH_WCBK_Product_Post_Type_Admin::is_booking( $product_id ) ) {
                ...
                if ( $product ) {
                    ...
                    if ( $passed_validation && $product->get_max_bookings_per_unit() ) {
                        ...
                        $bookings_added_to_cart_in_same_dates = $this->count_added_to_cart_bookings_in_period( $_count_args );
                        $booked_bookings_in_same_dates        = YITH_WCBK_Booking_Helper()->count_booked_bookings_in_period( array_merge( $_count_args, array( 'include_externals' => true ) ) );
