...
jQuery( document ).ready( function ( $ ) {
    ...
    $.fn.yith_wcbk_datepicker = function () {
        ...
        return $( this ).each( function () {
                                   ...
                                   $( this ).on( 'yith_wcbk_datepicker_load_non_available_dates', loadNotAvailableDates );
                                                             ...
                                                             onSelect       : function ( selectedDate, instance ) {
                                                                 ...
                                                                 if ( selectedDate ) {
                                                                     if ( to.length > 0 ) {
                                                                         ...
                                                                         _minDate = _durationToAdd > 0 ? yith_wcbk_dates.add_days_to_date( selectedDate, _durationToAdd ) : selectedDate;
