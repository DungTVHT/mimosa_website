...
$operators = array( 'add' => '+', 'sub' => '-', 'mul' => '*', 'div' => '/', 'add-percentage' => '+%', 'sub-percentage' => '-%' );
...
<div class="yith-wcbk-settings-section-box yith-wcbk-price-rule <?php echo $default_toggle_class ?>" data-index="<?php echo $index ?>">
    ...
    <div class="yith-wcbk-settings-section-box__content">
        ...
        <span class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--small yith-wcbk-admin-button--plus yith-wcbk-price-rule__conditions__new-condition'>" .
        ...
        <div class="yith-wcbk-settings-section-box__content__actions yith-wcbk-right">
            <span class="yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-price-rules__delete-rule"><?php _e( 'Delete rule', 'yith-booking-for-woocommerce' ) ?></span>
        </div>
    </div>
</div>