                           ...
                           'fields' => array(
                               ...
                               array(
                                   ...
                                   'fields' => array(
                                       array(
                                           'type'  => 'html',
                                           'value' => $condition_index !== 1 ? "<label class='yith-wcbk-price-rule__condition__from-label'></label><span class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--small yith-wcbk-price-rule__condition__delete-condition'>" . __( 'Delete condition', 'yith-booking-for-woocommerce' ) . "</span>" : '',
                                       )
                                   )
                               ),
                           )
