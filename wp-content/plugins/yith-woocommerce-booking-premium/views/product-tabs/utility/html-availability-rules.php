...
<div class="yith-wcbk-availability-rules">
    <div class="yith-wcbk-settings-section-box__sortable-container yith-wcbk-availability-rules__list">
        <?php foreach ( $availability_rules as $index => $availability_rule ) {
    ...
    <div class="yith-wcbk-settings-section__content__actions">
        <span class="yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--plus yith-wcbk-availability-rules__new-rule" data-template="<?php
        $index             = '{{INDEX}}';
