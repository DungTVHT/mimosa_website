...
<div class="yith-wcbk-booking-actions-metabox-content">
    <p style="text-align: center">
        <a href="<?php echo $booking_pdf_customer_link ?>" class="yith-wcbk-admin-button yith-wcbk-admin-button--small yith-wcbk-admin-button--secondary" target="_blank"><?php _e( 'Customer PDF', 'yith-booking-for-woocommerce' ) ?></a>
        <a href="<?php echo $booking_pdf_admin_link ?>" class="yith-wcbk-admin-button yith-wcbk-admin-button--small yith-wcbk-admin-button--secondary" target="_blank"><?php _e( 'Admin PDF', 'yith-booking-for-woocommerce' ) ?></a>
    </p>
