            ...
            <p class="form-field form-field-wide yith-booking-product">
                <label for="yith_booking_product"><?php _e( 'Booking Product:', 'yith-booking-for-woocommerce' ) ?>
                    ...
                    if ( !empty( $booking->product_id ) ) {
                        $product_edit_link = get_edit_post_link( $booking->product_id );
                ...
                if ( !empty( $booking->product_id ) ) {
                    ...
                    $product_string               = $product->get_formatted_name();
                    $data_selected[ $product_id ] = $product_string;
                }
                echo "<p>$product_string</p>";
                ?>
            </p>
