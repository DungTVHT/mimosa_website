...
<form method='POST' enctype='multipart/form-data'>
    <h3><?php _e( 'Set Client ID and Client Secret', 'yith-booking-for-woocommerce' ) ?></h3>
    ...
    <div class='yith-wcbk-google-calendar-actions__container'>
        <div class='yith-wcbk-google-calendar-actions'>
            <input type='submit' value='<?php _e( 'Save', 'yith-booking-for-woocommerce' ) ?>' class='yith-wcbk-google-calendar-button'>
        </div>
    </div>
</form>