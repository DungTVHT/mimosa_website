...
<div id="yith-wcbk-logs">
    <h2><?php _ex( 'Logs', 'Settings tab title', 'yith-booking-for-woocommerce' ); ?>
        <a class="page-title-action" href="<?php echo $delete_log_url ?>"><?php _e( 'Delete Logs', 'yith-booking-for-woocommerce' ) ?></a>
    </h2>
